...
Target "CreatePackage" (fun _ ->
    ...
    NuGetPack (fun p -> 
        {p with
            ...
            Project = "MachinaAurum.Collections.SqlServer"
            Description = "Implementations of .NET Collections to SQL Server"                               
            OutputPath = buildDir @@ "nuget"
            Summary = "Implementations of .NET Collections to SQL Server" 
            WorkingDir = buildDir
            Version = gitVersion
            AccessKey = "myAccesskey"
            Publish = true }) "MachinaAurum.Collections.SqlServer.nuspec"
)
